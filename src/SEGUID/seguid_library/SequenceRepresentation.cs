...
namespace SEGUID
{
    ...
    /// </summary>
    public class SequenceRepresentation
    {
        /// <summary>
        ...
        public class ParseResult
        {
            ...
            public ParseResult(string type, string spec, string? watson = null, string? crick = null)
            {
        ...
        /// <returns>ParseResult containing sequence type and strands</returns>
        ...
        public static ParseResult ParseSequenceString(string spec)
        {
            if (spec == null)
                throw new ArgumentNullException(nameof(spec), "Argument must be a string");

            // Single-stranded sequence
            Match singleMatch = Regex.Match(spec, @"^([0-9A-Za-z-]+)$");
            if (singleMatch.Success)
            {
                return new ParseResult("ss", spec);
            }
            ...
            if (semicolonMatch.Success)
            {
                ...
                return new ParseResult("ds", spec, watson, crick);
            }
